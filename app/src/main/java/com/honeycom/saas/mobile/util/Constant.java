...
public class Constant {
     ...
     */
//    public static final String PAGE_URL = "http://mestestwebk8s.zhizaoyun.com:31811";//String.format("https://%s.zhizaoyun.com/", getCurrentDomain()[0]);
...
//    public static final String userPushRelation = INTERFACE_URL+"api-msg/userPushRelation";//保存用户推送关系
    ...
    public static final String WEBVERSION = INTERFACE_URL+"/api-p/tClientVersion/newVersion?equipmentType=1&updateVersion=";//apk升级功能
